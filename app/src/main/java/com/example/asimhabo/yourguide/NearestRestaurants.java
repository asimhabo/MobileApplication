...
public class NearestRestaurants extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearest_restaurants);
        bul = findViewById(R.id.button1);
        maptipi = findViewById(R.id.maptipi1);
        zoomctrl = findViewById(R.id.zoomctrl1);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(ActivityCompat.checkSelfPermission(NearestRestaurants.this,Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_DENIED){

            ActivityCompat.requestPermissions(NearestRestaurants.this,new String [] {Manifest.permission.ACCESS_FINE_LOCATION},1);
...
//                mMap.moveCamera(CameraUpdateFactory.zoomOut());
        ...
        bul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest istek = new StringRequest(StringRequest.Method.GET, adres, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            Toast.makeText(NearestRestaurants.this, hata.getMessage() , Toast.LENGTH_SHORT).show();
                ...
                RequestQueue kuyruk = Volley.newRequestQueue(NearestRestaurants.this);
                kuyruk.add(istek);
