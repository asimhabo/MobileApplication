...
public class NearestAccommodation extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearest_accommodation);
        bul = findViewById(R.id.button2);
        maptipi = findViewById(R.id.maptipi2);
        zoomctrl = findViewById(R.id.zoomctrl2);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        if(ActivityCompat.checkSelfPermission(NearestAccommodation.this,Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_DENIED){

            ActivityCompat.requestPermissions(NearestAccommodation.this,new String [] {Manifest.permission.ACCESS_FINE_LOCATION},1);
...
//                mMap.moveCamera(CameraUpdateFactory.zoomOut());
        ...
        bul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest istek = new StringRequest(StringRequest.Method.GET, adres, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            Toast.makeText(NearestAccommodation.this, hata.getMessage() , Toast.LENGTH_SHORT).show();
                ...
                RequestQueue kuyruk = Volley.newRequestQueue(NearestAccommodation.this);
                kuyruk.add(istek);
